        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameTypeId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Games", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Games_GameTypes_GameTypeId1",
                        column: x => x.GameTypeId1,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EloTargetId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tournaments_Ranks_EloTargetId",
                        column: x => x.EloTargetId,
                        principalTable: "Ranks",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefeatedId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DefeatedPlayerId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    GameId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlayerGame_AspNetUsers_DefeatedPlayerId",
                        column: x => x.DefeatedPlayerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PlayerGame_AspNetUsers_WinnerId",
                        column: x => x.WinnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlayerTournaments_AspNetUsers_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Games_GameTypeId1",
                table: "Games",
                column: "GameTypeId1");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerGame_DefeatedPlayerId",
                table: "PlayerGame",
                column: "DefeatedPlayerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tournaments_EloTargetId",
                table: "Tournaments",
                column: "EloTargetId");
